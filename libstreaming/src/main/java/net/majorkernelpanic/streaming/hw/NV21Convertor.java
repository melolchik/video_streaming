...
import static net.majorkernelpanic.streaming.AppLogger.log;
...
public class NV21Convertor {
    ...
    public String toString() {
        ...
        builder.append(" mSliceHeight = ").append(mSliceHeight)
        .append("mHeight = ").append(mHeight).append("mWidth = ").append(mWidth)
